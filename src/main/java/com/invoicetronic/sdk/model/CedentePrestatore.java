...
import com.invoicetronic.sdk.model.Contatti;
import com.invoicetronic.sdk.model.DatiAnagraficiCedentePrestatore;
import com.invoicetronic.sdk.model.IscrizioneREA;
import com.invoicetronic.sdk.model.SedeCedentePrestatore;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CedentePrestatore.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CedentePrestatore is not found in the empty JSON string", CedentePrestatore.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CedentePrestatore.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CedentePrestatore` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
