...
public class SendReduced implements Serializable {
  ...
  public SendReduced latestState(@javax.annotation.Nullable LatestStateEnum latestState) {
  ...
  public void setLatestState(@javax.annotation.Nullable LatestStateEnum latestState) {
    this.latestState = latestState;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identifier, sendReduced.identifier) &&
        ...
        Objects.equals(this.latestState, sendReduced.latestState);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(identifier, prestatore, metaData, documents, dateSent, latestState);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("identifier", "prestatore", "meta_data", "documents", "date_sent", "latest_state"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SendReduced.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SendReduced is not found in the empty JSON string", SendReduced.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SendReduced.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SendReduced` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
