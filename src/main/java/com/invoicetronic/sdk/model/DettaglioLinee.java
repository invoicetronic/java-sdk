  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DettaglioLinee.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DettaglioLinee is not found in the empty JSON string", DettaglioLinee.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DettaglioLinee.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DettaglioLinee` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("tipo_cessione_prestazione") != null && !jsonObj.get("tipo_cessione_prestazione").isJsonNull()) && !jsonObj.get("tipo_cessione_prestazione").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `tipo_cessione_prestazione` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tipo_cessione_prestazione").toString()));
      }
      if (jsonObj.get("codice_articolo") != null && !jsonObj.get("codice_articolo").isJsonNull()) {
        ...
        if (jsonArraycodiceArticolo != null) {
          ...
          if (!jsonObj.get("codice_articolo").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `codice_articolo` to be an array in the JSON string but got `%s`", jsonObj.get("codice_articolo").toString()));
          }
      ...
      if ((jsonObj.get("unita_misura") != null && !jsonObj.get("unita_misura").isJsonNull()) && !jsonObj.get("unita_misura").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `unita_misura` to be a primitive type in the JSON string but got `%s`", jsonObj.get("unita_misura").toString()));
      }
      if (jsonObj.get("sconto_maggiorazione") != null && !jsonObj.get("sconto_maggiorazione").isJsonNull()) {
        ...
        if (jsonArrayscontoMaggiorazione != null) {
          ...
          if (!jsonObj.get("sconto_maggiorazione").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sconto_maggiorazione` to be an array in the JSON string but got `%s`", jsonObj.get("sconto_maggiorazione").toString()));
          }
      ...
      if ((jsonObj.get("ritenuta") != null && !jsonObj.get("ritenuta").isJsonNull()) && !jsonObj.get("ritenuta").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `ritenuta` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ritenuta").toString()));
      }
      if ((jsonObj.get("natura") != null && !jsonObj.get("natura").isJsonNull()) && !jsonObj.get("natura").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `natura` to be a primitive type in the JSON string but got `%s`", jsonObj.get("natura").toString()));
      }
      if ((jsonObj.get("riferimento_amministrazione") != null && !jsonObj.get("riferimento_amministrazione").isJsonNull()) && !jsonObj.get("riferimento_amministrazione").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `riferimento_amministrazione` to be a primitive type in the JSON string but got `%s`", jsonObj.get("riferimento_amministrazione").toString()));
      }
      if (jsonObj.get("altri_dati_gestionali") != null && !jsonObj.get("altri_dati_gestionali").isJsonNull()) {
        ...
        if (jsonArrayaltriDatiGestionali != null) {
          ...
          if (!jsonObj.get("altri_dati_gestionali").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `altri_dati_gestionali` to be an array in the JSON string but got `%s`", jsonObj.get("altri_dati_gestionali").toString()));
          }
