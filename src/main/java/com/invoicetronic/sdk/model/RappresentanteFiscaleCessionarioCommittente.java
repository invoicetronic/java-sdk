...
public class RappresentanteFiscaleCessionarioCommittente implements Serializable {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("denominazione", "nome", "cognome", "id_fiscale_iva"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RappresentanteFiscaleCessionarioCommittente.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RappresentanteFiscaleCessionarioCommittente is not found in the empty JSON string", RappresentanteFiscaleCessionarioCommittente.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RappresentanteFiscaleCessionarioCommittente.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RappresentanteFiscaleCessionarioCommittente` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
