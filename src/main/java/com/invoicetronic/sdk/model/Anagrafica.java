  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Anagrafica.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Anagrafica is not found in the empty JSON string", Anagrafica.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Anagrafica.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Anagrafica` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("denominazione") != null && !jsonObj.get("denominazione").isJsonNull()) && !jsonObj.get("denominazione").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `denominazione` to be a primitive type in the JSON string but got `%s`", jsonObj.get("denominazione").toString()));
      }
      ...
      if ((jsonObj.get("cognome") != null && !jsonObj.get("cognome").isJsonNull()) && !jsonObj.get("cognome").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `cognome` to be a primitive type in the JSON string but got `%s`", jsonObj.get("cognome").toString()));
      }
      if ((jsonObj.get("titolo") != null && !jsonObj.get("titolo").isJsonNull()) && !jsonObj.get("titolo").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `titolo` to be a primitive type in the JSON string but got `%s`", jsonObj.get("titolo").toString()));
      }
      if ((jsonObj.get("cod_eori") != null && !jsonObj.get("cod_eori").isJsonNull()) && !jsonObj.get("cod_eori").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `cod_eori` to be a primitive type in the JSON string but got `%s`", jsonObj.get("cod_eori").toString()));
      }
  }
