...
public class Event implements Serializable {
  ...
  public Event method(@javax.annotation.Nonnull String method) {
    this.method = method;
    return this;
  }
  ...
  public Event endpoint(@javax.annotation.Nonnull String endpoint) {
  ...
  public Event userAgent(@javax.annotation.Nullable String userAgent) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, created, version, userId, apiKeyId, companyId, method, endpoint, apiVersion, statusCode, dateTime, error, resourceId, userAgent, success, query, responseBody);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "created", "version", "user_id", "api_key_id", "company_id", "method", "endpoint", "api_version", "status_code", "date_time", "error", "resource_id", "user_agent", "success", "query", "response_body"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("method", "endpoint"));
  }
