  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Allegati.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Allegati is not found in the empty JSON string", Allegati.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Allegati.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Allegati` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("nome_attachment") != null && !jsonObj.get("nome_attachment").isJsonNull()) && !jsonObj.get("nome_attachment").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `nome_attachment` to be a primitive type in the JSON string but got `%s`", jsonObj.get("nome_attachment").toString()));
      }
      if ((jsonObj.get("algoritmo_compressione") != null && !jsonObj.get("algoritmo_compressione").isJsonNull()) && !jsonObj.get("algoritmo_compressione").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `algoritmo_compressione` to be a primitive type in the JSON string but got `%s`", jsonObj.get("algoritmo_compressione").toString()));
      }
      if ((jsonObj.get("formato_attachment") != null && !jsonObj.get("formato_attachment").isJsonNull()) && !jsonObj.get("formato_attachment").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `formato_attachment` to be a primitive type in the JSON string but got `%s`", jsonObj.get("formato_attachment").toString()));
      }
      if ((jsonObj.get("descrizione_attachment") != null && !jsonObj.get("descrizione_attachment").isJsonNull()) && !jsonObj.get("descrizione_attachment").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `descrizione_attachment` to be a primitive type in the JSON string but got `%s`", jsonObj.get("descrizione_attachment").toString()));
      }
  }
