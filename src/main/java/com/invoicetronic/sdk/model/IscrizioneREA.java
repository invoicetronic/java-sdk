  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IscrizioneREA.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in IscrizioneREA is not found in the empty JSON string", IscrizioneREA.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IscrizioneREA.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `IscrizioneREA` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("ufficio") != null && !jsonObj.get("ufficio").isJsonNull()) && !jsonObj.get("ufficio").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `ufficio` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ufficio").toString()));
      }
      if ((jsonObj.get("numero_rea") != null && !jsonObj.get("numero_rea").isJsonNull()) && !jsonObj.get("numero_rea").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `numero_rea` to be a primitive type in the JSON string but got `%s`", jsonObj.get("numero_rea").toString()));
      }
      if ((jsonObj.get("socio_unico") != null && !jsonObj.get("socio_unico").isJsonNull()) && !jsonObj.get("socio_unico").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `socio_unico` to be a primitive type in the JSON string but got `%s`", jsonObj.get("socio_unico").toString()));
      }
      if ((jsonObj.get("stato_liquidazione") != null && !jsonObj.get("stato_liquidazione").isJsonNull()) && !jsonObj.get("stato_liquidazione").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `stato_liquidazione` to be a primitive type in the JSON string but got `%s`", jsonObj.get("stato_liquidazione").toString()));
      }
  }
