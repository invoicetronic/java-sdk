  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatiRiepilogo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DatiRiepilogo is not found in the empty JSON string", DatiRiepilogo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatiRiepilogo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DatiRiepilogo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("esigibilita_iva") != null && !jsonObj.get("esigibilita_iva").isJsonNull()) && !jsonObj.get("esigibilita_iva").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `esigibilita_iva` to be a primitive type in the JSON string but got `%s`", jsonObj.get("esigibilita_iva").toString()));
      }
      if ((jsonObj.get("riferimento_normativo") != null && !jsonObj.get("riferimento_normativo").isJsonNull()) && !jsonObj.get("riferimento_normativo").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `riferimento_normativo` to be a primitive type in the JSON string but got `%s`", jsonObj.get("riferimento_normativo").toString()));
      }
  }
