  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FatturaElettronicaBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FatturaElettronicaBody is not found in the empty JSON string", FatturaElettronicaBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FatturaElettronicaBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `FatturaElettronicaBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("dati_pagamento") != null && !jsonObj.get("dati_pagamento").isJsonNull()) {
        ...
        if (jsonArraydatiPagamento != null) {
          ...
          if (!jsonObj.get("dati_pagamento").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `dati_pagamento` to be an array in the JSON string but got `%s`", jsonObj.get("dati_pagamento").toString()));
          }
      ...
      if (jsonObj.get("allegati") != null && !jsonObj.get("allegati").isJsonNull()) {
        ...
        if (jsonArrayallegati != null) {
          ...
          if (!jsonObj.get("allegati").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `allegati` to be an array in the JSON string but got `%s`", jsonObj.get("allegati").toString()));
          }
