...
public class WebHookHistory implements Serializable {
  ...
  public WebHookHistory error(@javax.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, webHookHistory.id) &&
        ...
        Objects.equals(this.error, webHookHistory.error) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, created, version, webHookId, userId, event, statusCode, error, dateTime, success);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "created", "version", "web_hook_id", "user_id", "event", "status_code", "error", "date_time", "success"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebHookHistory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in WebHookHistory is not found in the empty JSON string", WebHookHistory.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebHookHistory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WebHookHistory` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
