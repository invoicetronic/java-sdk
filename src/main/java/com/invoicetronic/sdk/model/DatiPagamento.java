  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatiPagamento.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DatiPagamento is not found in the empty JSON string", DatiPagamento.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatiPagamento.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DatiPagamento` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("condizioni_pagamento") != null && !jsonObj.get("condizioni_pagamento").isJsonNull()) && !jsonObj.get("condizioni_pagamento").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `condizioni_pagamento` to be a primitive type in the JSON string but got `%s`", jsonObj.get("condizioni_pagamento").toString()));
      }
      if (jsonObj.get("dettaglio_pagamento") != null && !jsonObj.get("dettaglio_pagamento").isJsonNull()) {
        ...
        if (jsonArraydettaglioPagamento != null) {
          ...
          if (!jsonObj.get("dettaglio_pagamento").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `dettaglio_pagamento` to be an array in the JSON string but got `%s`", jsonObj.get("dettaglio_pagamento").toString()));
          }
