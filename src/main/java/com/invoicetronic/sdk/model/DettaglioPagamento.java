  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DettaglioPagamento.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DettaglioPagamento is not found in the empty JSON string", DettaglioPagamento.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DettaglioPagamento.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DettaglioPagamento` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("beneficiario") != null && !jsonObj.get("beneficiario").isJsonNull()) && !jsonObj.get("beneficiario").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `beneficiario` to be a primitive type in the JSON string but got `%s`", jsonObj.get("beneficiario").toString()));
      }
      if ((jsonObj.get("modalita_pagamento") != null && !jsonObj.get("modalita_pagamento").isJsonNull()) && !jsonObj.get("modalita_pagamento").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `modalita_pagamento` to be a primitive type in the JSON string but got `%s`", jsonObj.get("modalita_pagamento").toString()));
      }
      if ((jsonObj.get("cod_ufficio_postale") != null && !jsonObj.get("cod_ufficio_postale").isJsonNull()) && !jsonObj.get("cod_ufficio_postale").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `cod_ufficio_postale` to be a primitive type in the JSON string but got `%s`", jsonObj.get("cod_ufficio_postale").toString()));
      }
      if ((jsonObj.get("cognome_quietanzante") != null && !jsonObj.get("cognome_quietanzante").isJsonNull()) && !jsonObj.get("cognome_quietanzante").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `cognome_quietanzante` to be a primitive type in the JSON string but got `%s`", jsonObj.get("cognome_quietanzante").toString()));
      }
      if ((jsonObj.get("nome_quietanzante") != null && !jsonObj.get("nome_quietanzante").isJsonNull()) && !jsonObj.get("nome_quietanzante").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `nome_quietanzante` to be a primitive type in the JSON string but got `%s`", jsonObj.get("nome_quietanzante").toString()));
      }
      if ((jsonObj.get("cf_quietanzante") != null && !jsonObj.get("cf_quietanzante").isJsonNull()) && !jsonObj.get("cf_quietanzante").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `cf_quietanzante` to be a primitive type in the JSON string but got `%s`", jsonObj.get("cf_quietanzante").toString()));
      }
      if ((jsonObj.get("titolo_quietanzante") != null && !jsonObj.get("titolo_quietanzante").isJsonNull()) && !jsonObj.get("titolo_quietanzante").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `titolo_quietanzante` to be a primitive type in the JSON string but got `%s`", jsonObj.get("titolo_quietanzante").toString()));
      }
      if ((jsonObj.get("istituto_finanziario") != null && !jsonObj.get("istituto_finanziario").isJsonNull()) && !jsonObj.get("istituto_finanziario").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `istituto_finanziario` to be a primitive type in the JSON string but got `%s`", jsonObj.get("istituto_finanziario").toString()));
      }
      ...
      if ((jsonObj.get("abi") != null && !jsonObj.get("abi").isJsonNull()) && !jsonObj.get("abi").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `abi` to be a primitive type in the JSON string but got `%s`", jsonObj.get("abi").toString()));
      }
      if ((jsonObj.get("cab") != null && !jsonObj.get("cab").isJsonNull()) && !jsonObj.get("cab").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `cab` to be a primitive type in the JSON string but got `%s`", jsonObj.get("cab").toString()));
      }
      ...
      if ((jsonObj.get("codice_pagamento") != null && !jsonObj.get("codice_pagamento").isJsonNull()) && !jsonObj.get("codice_pagamento").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `codice_pagamento` to be a primitive type in the JSON string but got `%s`", jsonObj.get("codice_pagamento").toString()));
      }
  }
