...
import com.invoicetronic.sdk.auth.Authentication;
import com.invoicetronic.sdk.auth.HttpBasicAuth;
import com.invoicetronic.sdk.auth.HttpBearerAuth;
import com.invoicetronic.sdk.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected void init() {
        ...
        setUserAgent("Invoicetronic/1.1.2/Java-SDK");
     ...
     * @return a {@link com.invoicetronic.sdk.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.invoicetronic.sdk.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.invoicetronic.sdk.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.invoicetronic.sdk.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.invoicetronic.sdk.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.invoicetronic.sdk.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.invoicetronic.sdk.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.invoicetronic.sdk.ApiException If fails to update the parameters
     */
     ...
     * @throws com.invoicetronic.sdk.ApiException If fail to serialize the request body object into a string
     */
